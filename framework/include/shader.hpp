...
//
//        struct Description {
//            Description& set_filepath(std::filesystem::path path);
//
//            // Compile-time (macro) definition
//            Description& define_macro(const char* name, const char* value);
//
//            // Vulkan GLSL specialization constants
//            // Can be one of: bool, integer, unsigned integer, float, double
//            template <typename T>
//            Description& define_constant(const char* name, T value);
//
