...
//            initialize_blur_pipelines();
        ...
        void initialize_pipeline() {
            ...
            //      vertex bindings (VkVertexInputBindingDescription)
            //      vertex attribute descriptions (VkVertexInputAttributeDescription)
            
            // Provided by the user
            // shader stages (VkPipelineShaderStageCreateInfo)
            // input assembly state (topology) (VkPipelineInputAssemblyStateCreateInfo)
            // viewport information (VkPipelineViewportStateCreateInfo)
            //      viewport (VkViewport)
            //      scissor (VkRect2D)
            // rasterization properties (VkPipelineRasterizationStateCreateInfo)
            // multisampling (VkPipelineMultisampleStateCreateInfo)
            // depth and stencil state (VkPipelineDepthStencilStateCreateInfo)
            // blending (per attachment?) (VkPipelineColorBlendAttachmentState, VkPipelineColorBlendStateCreateInfo)
            //
